...
void loop() {
  ...
  if (radio.available()) {
      ...
      if (data > 200) {
        P_data = data / 10; //To differentiate P_data from the R_data, multiply the data from the slide_pot then devide it in equal number 
        P_data = P_data * 11/ 52;
      ...
      Serial.print("Handle:");Serial.print(R_data);
      Serial.print("         ");
